...
\begin{figure}[h]
    \centering
    \includegraphics[width=\columnwidth]{fig/original_distribution.svg}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\columnwidth]{fig/balanced_distribution.svg}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\columnwidth]{fig/rf_original_confusion_matrix.svg}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\columnwidth]{fig/rf_balanced_confusion_matrix.svg}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\columnwidth]{fig/cnn_original_history.svg}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\columnwidth]{fig/cnn_original_confusion_matrix.svg}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\columnwidth]{fig/cnn_balanced_history.svg}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\columnwidth]{fig/cnn_balanced_confusion_matrix.svg}
